      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in-up-delay">
          <button
            ...
            className="inline-flex items-center px-6 py-3 bg-primary text-primary-foreground font-semibold rounded-lg hover-lift hover-scale focus:outline-none focus:ring-2 focus:ring-ring transition-all duration-300"
          ...
          <button
            ...
            className="inline-flex items-center px-6 py-3 glass text-foreground font-semibold rounded-lg hover-glow hover-scale focus:outline-none focus:ring-2 focus:ring-ring transition-all duration-300"
